...
int main() {
	...
	while (test != -1){
		...
		//cout << "\nRead function for current state " << actionTable.Read().currentState;
		//cout << "\nRead function for symbol read " << actionTable.Read().symbolRead;
		//cout << "\nRead function for next state  " << actionTable.Read().nextState;
		//cout << "\nRead function for symbol write " << actionTable.Read().symbolWrite;
		//cout << "\nRead function for direction " << actionTable.Read().direction << endl;
		inData >> test;
	} 
	inData.ignore(100, '\n');
	int position;
